...
// import typefaceFont from '/examples/fonts/helvetiker_regular.typeface.json'
...
const matcapTexture = textureLoader.load('/textures/matcaps/8.png', texture => {
    console.log(`texture id=${texture.id} loaded`)
})
